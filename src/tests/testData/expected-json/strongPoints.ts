export const strongPoints_ja = [
  ...
  },
  {
    ...
    question: '健康管理能力と体力',
    answer:
      '学生時代に鍛えた体力で、過酷な環境でも働き続けることができます。ホテルでの週5夜勤8時間労働を1年間行う体力があり、病気にもほとんどならないため、病気で休むことなく、仕事のパフォーマンスも落とすことなく仕事に従事することができます。\n仕事を始めて、現在まで病気等での休みをいただいたことがありません。',
  },
  {
    size: 'small',
    question: 'システム使用者への気遣い',
    answer:
      'ホテルにて働いた経験から、どのように気遣いを行いお客様を喜ばせるかを考えるようになったため、お客様目線になって、どういったシステムが使いやすいかを考え開発をすることができます。\n一部システム使用者への気遣いを行いすぎて、逆に一度ダメな実装を行ってしまった経験があります。\n\n(非ITの方は、CSVファイルをexcelで開いてしまうため、excelで開いた際にも、勝手な変換などが行われないように、出力のフォーマットを調整していましたが、データ連携でもCSVを使用するということで、余計なフォーマットを入れてしまいました。)\n',
  },
  {
    size: 'small',
    question: '効率化を求める性格',
    answer:
      '日頃の生活にて、効率を求めて生活をしているため、ただシステムを開発するだけでなく、最適化を求め、拡張性や柔軟性を考え開発を行うことができます。',
  },
  {
    size: 'large',
...
export const strongPoints_en = [
  ...
  },
  {
    ...
    answer:
      'With physical strength developed during my student years, I can continue working even in demanding environments. I have the stamina to work night shifts 5 days a week, 8 hours a day for a year at a hotel. I rarely get sick, allowing me to work without taking sick leave and maintaining consistent performance.\nSince starting my professional career, I have never taken time off due to illness.',
  },
  {
    size: 'small',
    question: 'Consideration for System Users',
    answer:
      "From my experience working at a hotel, I learned how to be attentive to customers and make them happy. This allows me to develop systems from the user's perspective, considering what would be most user-friendly.\nI once had an experience where I was overly considerate of system users, which ironically led to a poor implementation.\n\n(Non-IT users often open CSV files in Excel, so I adjusted the output format to prevent automatic conversions when opened in Excel. However, this became problematic when the CSV was also used for data integration, as I had added unnecessary formatting.)\n",
  },
  {
    size: 'small',
    question: 'Efficiency-Oriented Personality',
    answer:
      'Because I seek efficiency in my daily life, I can develop systems with not just functionality in mind, but also optimization, extensibility, and flexibility.',
  },
  {
    size: 'large',
