...
lazy_static! {
    pub static ref STRONG_POINTS_JA: Vec<StrongPoint> = vec![
        ...
        StrongPoint {
            size: "small".to_string(),
            question: "効率化を求める性格".to_string(),
            answer: "日頃の生活にて、効率を求めて生活をしているため、ただシステムを開発するだけでなく、最適化を求め、拡張性や柔軟性を考え開発を行うことができます。".to_string(),
        },
        StrongPoint {
            size: "large".to_string(),
            question: "学生時代と家庭教師のアルバイトで培った教育力".to_string(),
            answer: "学生時代から人に物事を教えたりする経験があり、家庭教師のアルバイトでは、指導させていただいたお子様を見事志望校へ合格させることができました。\nホテルでの経験も合わせまして、人の気持ちにたった指導を行うことができるため、わかりやすく、指導することができます。\n\nどの職場でも、新人の教育を行ったり、新人教育用の資料作成を行い、教育に貢献出来ました。".to_string(),
        },
        StrongPoint {
            size: "small".to_string(),
            question: "高い場合分け能力".to_string(),
            answer: "想定される事象や条件を網羅的に洗い出し、ロジックの不整合やバグの発生、リスクを未然に防ぐことができます。".to_string(),
        },
        StrongPoint {
            size: "medium".to_string(),
            question: "アイデア実現能力と問題解決力".to_string(),
            answer: "お客さまもしくは自分が提案したアイデアを実装に落とし込むことができます。単にお客さまの要望を満たすだけでなく、根本の問題や本当に実現したいことを確認し、それに応じた代替案を提案します。モックなどを駆使し、アイデアの詳細を詰めて実現を促進します。".to_string(),
        },
        StrongPoint {
            size: "small".to_string(),
            question: "複雑な問題やバグの対処力".to_string(),
            answer: "もぐら叩きのように再発する問題やバグの対処に強みがあります。場合分け能力の高さを活かし、全体の整合性を考慮した上で、難解なコードやスパゲッティコード上での問題解決、最後の詰めの実装を得意としています。".to_string(),
        },
    ];

    pub static ref STRONG_POINTS_EN: Vec<StrongPoint> = vec![
        StrongPoint {
            size: "large".to_string(),
            question: "Quick Learning and Adaptability".to_string(),
            answer: "I am confident in my ability to quickly learn new knowledge. In every project, I was able to complete work using unfamiliar languages and technologies, performing as well as those with prior knowledge.\nThese experiences demonstrate my quick learning ability.\nEven if you feel my current skills are lacking, I can fill those gaps faster than you might expect.\nSince there is typically time before starting a new position, if you can provide information about your environment, I can prepare for a smoother transition to your projects.\nWhile it may take 1-3 months to follow project rules and best practices when developing in a new language, I can acquire sufficient knowledge to create \"working solutions\" in about a week.\n".to_string(),
        },
        StrongPoint {
            size: "large".to_string(),
            question: "Strong Specification Understanding".to_string(),
        ...
        StrongPoint {
            size: "large".to_string(),
            question: "Self-Initiative".to_string(),
        ...
        StrongPoint {
            size: "small".to_string(),
            question: "Efficiency-Oriented Personality".to_string(),
            answer: "Because I seek efficiency in my daily life, I can develop systems with not just functionality in mind, but also optimization, extensibility, and flexibility.".to_string(),
        },
        StrongPoint {
            size: "large".to_string(),
            question: "Teaching Skills Developed Through Tutoring".to_string(),
            answer: "I have experience teaching others since my student days, and as a private tutor, I successfully helped a student gain admission to their desired school.\nCombined with my hotel experience, I can provide instruction that considers others' feelings, making my teaching clear and easy to understand.\n\nIn every workplace, I contributed to education by training new employees and creating educational materials for newcomers.".to_string(),
        },
        StrongPoint {
            size: "small".to_string(),
            question: "Comprehensive Conditional Analysis".to_string(),
            answer: "I can exhaustively identify anticipated scenarios and conditions, preventing logical inconsistencies, bugs, and risks before they occur.".to_string(),
        },
        StrongPoint {
            size: "medium".to_string(),
            question: "Idea Realization and Problem-Solving".to_string(),
            answer: "I can translate ideas — whether proposed by clients or myself — into working implementations. Rather than simply fulfilling requests, I identify the underlying problem and what clients truly want to achieve, then propose suitable alternatives. I leverage mockups and other tools to refine idea details and drive realization.".to_string(),
        },
        StrongPoint {
            size: "small".to_string(),
            question: "Handling Complex Problems and Persistent Bugs".to_string(),
            answer: "I excel at resolving recurring whack-a-mole problems and bugs. Leveraging my strong conditional analysis skills, I consider overall system consistency to solve problems in complex or spaghetti code and handle the final critical implementation details.".to_string(),
        },
    ];
}
