...
export const workExperiences_ja: WorkExperience[] = [
  {
    ...
    role: 'フルスタック開発者',
    description: ['社内運用の人材系プラットフォーム開発'],
    archivement: ['未定'],
  },
  {
    company: 'お客さま4',
  ...
  },
  {
    ...
    archivement: ['モダンなデザインや、新機能について積極的に提案しました。'],
  },
  {
    company: 'お客さま3',
...
export const workExperiences_en: WorkExperience[] = [
  {
    ...
    description: ['Development of an internal HR platform'],
    archivement: ['TBD'],
  },
  {
    company: 'Customer4',
  ...
  },
  {
    ...
    role: 'Full Stack Developer',
    description: [
      'Desktop development with React-based Electron',
      'Development of interfaces to run external Python modules and exe modules',
    ],
    archivement: ['Actively proposed modern designs and new features.'],
  },
  {
    company: 'Customer3',
