...
export const skills: SkillItem[] = [
  ...
  },
  {
    ...
    category: 'Cloud',
    proficiency: onBusiness,
    picture: '/icons/AzurePipelines.svg',
    pictureColor: '#2560E0',
  },
  {
    name: 'Azure Repos',
  ...
  },
  {
    ...
    category: 'Cloud',
    proficiency: onBusiness,
    picture: '/icons/AzureWebApps.svg',
    pictureColor: '#0078D7',
  },
  {
...
export const S = {
  ...
  awsS3: n('AWS S3'),
  azureDevOps: n('Azure DevOps'),
  azurePipelines: n('Azure Pipelines'),
  azureRepos: n('Azure Repos'),
  azureWebApps: n('Azure Web Apps'),
  cloudflareWorkers: n('Cloudflare Workers'),
  ollama: n('Ollama'),
  rag: n('RAG'),
  stt: n('STT'),
  tts: n('TTS'),
  whisper: n('Whisper(local)'),
