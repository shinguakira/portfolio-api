...
var FaqsJA = []model.Faq{
	{
		Size:     "large",
		Category: "Timeline",
		Question: "なぜフリーランスになられましたか?",
		Answer:   "元々SESというフリーランスとほぼ変わらない働き方をしていて、SESの会社に所属するよりも、より幅広い案件に参画することができ、報酬も多くなりやすいためです。SESの延長というところで、特にフリーランスに関して不安などない状態でした。",
	},
	{
		Size:     "large",
		Category: "Others",
	...
	},
	{
		...
		Answer:   "2社目の会社が、AWSのパートナーになることを目指していたため、AWSの資格取得を推奨していたこと、AWS All Certified Engineerの表彰により、お客さまの知名度向上に微力ながら助力できると考えたためです。また認知度のない資格を取得しても、評価されない可能性があったためです。",
	},
	{
		Size:     "large",
		Category: "Timeline",
	...
	},
	{
		...
		Answer:   "会社が方向転換をし、ローコードを主体に受託開発を進めたいと考えており、私の考えと相反するためです。フルスクラッチで、技術力が求められる環境での開発を行いたいと考えていました。また、2社目の会社はJavaの案件がメインであり、当時携わっていた案件以外に携わるとなった場合に、Javaの案件もしくは、ローコードのプロジェクトしかない可能性があったためです。",
	},
}

var FaqsEN = []model.Faq{
	{
		Size:     "large",
		Category: "Timeline",
		Question: "Why did you become a freelancer?",
		Answer:   "I was working as a freelancer with a similar working method to SES, and I could participate in a wider range of projects and earn more. I was not worried about freelancing at the time of the extension of SES.",
	},
	{
		Size:     "large",
		Category: "Others",
	...
	},
	{
		...
		Answer:   "People who need systems primarily require the services and functionality those systems provide. Only after these are completed do aspects like security, reliability, and availability gain value. That's why I focus on development, which creates the service and functional aspects of systems.",
	},
	{
		Size:     "medium",
		Category: "Others",
	...
	},
	{
		...
		Answer:   "I failed one required course, which meant I had to repeat a year. This resulted in the suspension of my scholarship, making it financially impossible for me to continue my studies.",
	},
	{
		Size:     "small",
		Category: "Timeline",
