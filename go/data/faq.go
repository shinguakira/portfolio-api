...
var FaqsJA = []model.Faq{
	...
	},
	{
		...
		Answer:   "以前の会社が、AWSのパートナーになることを目指していたため、AWSの資格取得を推奨していたこと、AWS All Certified Engineerの表彰により、お客さまの知名度向上に微力ながら助力できると考えたためです。また認知度のない資格を取得しても、評価されない可能性があったためです。",
	},
	{
		Size:     "large",
		Category: "Timeline",
	...
	},
	{
		...
		Answer:   "会社が方向転換をし、ローコードを主体に受託開発を進めたいと考えており、私の考えと相反するためです。フルスクラッチで、技術力が求められる環境での開発を行いたいと考えていました。また、以前の会社はJavaの案件がメインであり、当時携わっていた案件以外に携わるとなった場合に、Javaの案件もしくは、ローコードのプロジェクトしかない可能性があったためです。",
	},
}
