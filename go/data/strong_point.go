...
var StrongPointsJA = []model.StrongPoint{
	{
		Size:     "large",
...
どの職場でも、新人の教育を行ったり、新人教育用の資料作成を行い、教育に貢献出来ました。`,
	},
	{
		Size:     "small",
		Question: "高い場合分け能力",
		Answer:   "想定される事象や条件を網羅的に洗い出し、ロジックの不整合やバグの発生、リスクを未然に防ぐことができます。",
	},
	{
		Size:     "medium",
		Question: "アイデア実現能力と問題解決力",
		Answer:   "お客さまもしくは自分が提案したアイデアを実装に落とし込むことができます。単にお客さまの要望を満たすだけでなく、根本の問題や本当に実現したいことを確認し、それに応じた代替案を提案します。モックなどを駆使し、アイデアの詳細を詰めて実現を促進します。",
	},
	{
		Size:     "small",
		Question: "複雑な問題やバグの対処力",
		Answer:   "もぐら叩きのように再発する問題やバグの対処に強みがあります。場合分け能力の高さを活かし、全体の整合性を考慮した上で、難解なコードやスパゲッティコード上での問題解決、最後の詰めの実装を得意としています。",
	},
}

var StrongPointsEN = []model.StrongPoint{
	{
		Size:     "large",
...
In every workplace, I contributed to education by training new employees and creating educational materials for newcomers.`,
	},
	{
		...
		Answer:   "I can exhaustively identify anticipated scenarios and conditions, preventing logical inconsistencies, bugs, and risks before they occur.",
	},
	{
		Size:     "medium",
	...
	},
	{
		...
		Answer:   "I excel at resolving recurring whack-a-mole problems and bugs. Leveraging my strong conditional analysis skills, I consider overall system consistency to solve problems in complex or spaghetti code and handle the final critical implementation details.",
	},
}
